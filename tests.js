...
describe('gET /stats', () => {
  it('gET /stats exists', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      .get('/stats')
      .end((err, res) => {
        chai.expect(err).to.be.null;
...
describe('------------------\nTASK 6\nGET /files/:id', () => {
  ...
  it('gET /files/:id invalid token user', () => new Promise((done) => {
    chai.request('http://localhost:5000')
...
describe('gET /files/:id', () => {
  ...
  it('gET /files/:id with no file linked to :id', () => new Promise((done) => {
    chai.request('http://localhost:5000')
...
describe('gET /files/:id', () => {
  ...
  it('gET /files/:id with no file linked to :id for this user', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      .get(`/files/${initialFolderId}`)
      .set('X-Token', initialUserToken)
      .end(async (err, res) => {
...
describe('gET /files', () => {
  ...
  it('gET /files invalid token user', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      .get('/files')
      .set('X-Token', `${initialUserToken}_121`)
      .end(async (err, res) => {
...
describe('gET /files', () => {
  ...
  it('gET /files with a wrong parentId and no page', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      .get('/files')
      .set('X-Token', initialUserToken)
...
describe('gET /files', () => {
  ...
  it('gET /files with no parentId and second page', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      .get('/files')
      .query({ page: 1 })
      .set('X-Token', initialUserToken)
...
describe('gET /files', () => {
  ...
  it('gET /files with no parentId and a page too far', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      .get('/files')
      .query({ page: 10 })
      .set('X-Token', initialUserToken)
...
describe('gET /files/:id/data', () => {
  ...
  it('gET /files/:id/data with an unpublished folder linked to :id but user authenticated and not owner', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      .get(`/files/${initialUnpublishedFolderId}/data`)
      .set('X-Token', initialUserToken)
      .end(async (err, res) => {
  ...
  it('gET /files/:id/data with a published folder linked to :id but user authenticated and not owner', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      .get(`/files/${initialPublishedFolderId}/data`)
      .set('X-Token', initialUserToken)
      .end(async (err, res) => {
...
describe('gET /files/:id/data', () => {
  ...
  it('gET /files/:id/data with an unpublished folder linked to :id and user authenticated and owner', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      .get(`/files/${initialUnpublishedFolderId}/data`)
      .set('X-Token', initialUserToken)
      .end(async (err, res) => {
  ...
  it('gET /files/:id/data with a published folder linked to :id and user authenticated and owner', () => new Promise((done) => {
    chai.request('http://localhost:5000')
      .get(`/files/${initialPublishedFolderId}/data`)
      .set('X-Token', initialUserToken)
      .end(async (err, res) => {
